...
class AssociationRuleLearningEngine(DefaultEngine):
    ...
    def extract_features_weight(self, item1):
        ...
        if item1.item_id: result1 = self.classify.documents_with_features.get(item1.item_id, False)
        ...
        if not result1:
            ...
            if item1.item_id: self.classify.documents_with_features[item1.item_id] = result1
