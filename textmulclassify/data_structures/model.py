...
class Distribution(list):
    ...
    def __init__(self, data1):
        if isinstance(data1, list): list1 = Counter(data1).most_common()
        if isinstance(data1, dict): list1 = sorted(data1.iteritems(), key=lambda i1: -i1[1])
...
class TMCModel(object):
    ...
    def test_item_ids(cls):
        ...
        def func():
            ...
            if cls.classify.max_train_data_count == 0: return [] # compact
